...
public class Spiral : MonoBehaviour {
    ...
    void Start () {
        ...
        for (var i = 0; i < itemCount; ++i)
        {
            ...
            // if (i < 2) {
            var tentaclePos = new Vector3(transform.position.x, transform.position.y + radius + 0.5f, z);
    ...
    private float omega = 4; //角速度 [radian/s]
    ...
    void Update()
    {
        ...
        if (isRotate == true) {
            ...
            // transform.position += new Vector3(0,0,0.002f*omega);
        }
